...
export default function AddAddressForm({ setDisplay }) {
    function Validate(currentInput) {
        ...
        if (!currentInput.postalCode) currentErrors.postalCode = "Postal Code is required.";
        ...
        if (!currentInput.phoneNumber) currentErrors.phoneNumber = "Phone Number is required.";
        ...
        if (!currentInput.streetNumber) currentErrors.streetNumber = "Street Number is required."; 
