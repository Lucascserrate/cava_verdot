    ...
    return (
        <div className={s.container}>
            ...
            <div className={s.flex}>
                ...
                <input className={s.email} type="email" placeholder='Email...' name='email' onChange={handleChange}/>
                <input className={s.email} type="name" placeholder='Name...' name='name' onChange={handleChange} />
                <br />
